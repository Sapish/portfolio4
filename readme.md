...
* Give the NPCs stats, such as strength and hit points.  
...
* Lett the player decide what the movement keys should be (or support awsd+space as whell as arrows + space)
...
* implement a interesting feature we have not thought of for the game (Alexander: ou do not have time to do quests ). 
